...
<head>
    ...
    <title>Admin Login/Sign-up Page</title>
...
xhr.onload = function() {
  ...
  var sbtn=document.querySelector("#sbtbtn");
    sbtn.style.display="block";
     ...
     else if(xhr.responseText.trim()=="exist"){
     ...
     document.querySelector("#login1").addEventListener("click",()=>{
      var data= new FormData(document.querySelector('#adminlogininfo'));
      var xhr = new XMLHttpRequest();
