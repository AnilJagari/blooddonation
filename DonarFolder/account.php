...
if($res1){
  ...
  if($con2->connect_error){
    ...
    $sql2="select fullname,phone,email,aadhaar,gender,bloodgroup,category,dateofbirth from donar where username='$username' and password='$password'";
...
<head>
    ...
    <title>Donar Account Page</title>
        ...
        <div class="card-body p-4">
          <div class="d-flex">
            <div class="flex-grow-1 ms-3">
              ...
              <p class="mb-2 pb-1"><?php echo $profission; ?></p>
              ...
              <div class="media">
                ...
                <div class="px-3">
                  <p class="small text-muted mb-1">Blood Group</p>
                  <p class="mb-0"><?php echo $bloodgroup;?></p>
                </div>
              ...
              <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger me-1 flex-grow-1" id="request">Request</button>
                <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-primary  flex-grow-1">Add Job Info</button>
              </div>
              <div class="d-flex pt-1">
...
<script>
  ...
  document.querySelector("#request").addEventListener("click",()=>{
    ...
    var para=document.querySelector("#paraforrequest");
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            if(result.trim()==="done"){
              para.innerText="your Request has been successfully sent, wait for hospital response";
              para.style.color="green";
              document.querySelector("#request").disabled="true"; 
            }
            else if(result.trim()==="already done"){
              para.style.color="red"; 
            para.innerText="your donation done";
            document.querySelector("#request").disabled="true";
